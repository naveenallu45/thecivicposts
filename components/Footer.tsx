      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-orange-600 font-serif">
              The Civic Posts
            </h3>
            <p className="text-gray-400 text-sm">
              Your trusted source for news, entertainment, sports, health, and editorial content.
            </p>
          </div>

          {/* Quick Links and Social Media Side by Side on Mobile */}
          <div className="grid grid-cols-2 md:grid-cols-1 gap-6 md:col-span-2 md:grid-cols-2">
            {/* Quick Links */}
            <div>
